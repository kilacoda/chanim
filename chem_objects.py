...
class ChemObject(TexMobject):
    ...
    def set_ion_position(self,
        ...
        self[string_number][e_index]\
            .move_to(self[final_atom_index]
                     .get_edge_center(direction) + direction*0.2
                     )
...
class ComplexChemIon(TexMobject):
    ...
    def __init__(self, chem_code, **kwargs):
        ...
        self.comp = "\chemleft[\chemfig{"+chem_code+"}\chemright]^{%s}"%self.charge
...
class ChemName(TexMobject):
    ...
    """
    CONFIG = {
        "template_tex_file_body": TEMPLATE_CHEMNAME_FILE_BODY,
        "stroke_width": 2
    }
    ...
    def __init__(self, chem, name, buff=1, **kwargs):
        ...
        chem_with_name = "\\chemname[%sem]{\\chemfig{%s}}{%s}" % (
            buff, chem, name
        )
...
class ReactionVGroup(VGroup):
    ...
    def __init__(self,
        ...
        self.set_same_height_for_all_mobjects([VGroup(*r),
                                               arrow,
                                               VGroup(*p)])
